$(function() {
        ...
        if (isColision()) { 
            ...
            soundManager.play('hit2',{
                ...
                onfinish:function() {
                    ...
                    $guile.addClass('hit2');
                    setTimeout(function() { $guile.removeClass('hit2'); }, 1000);
                }
            });
        }
    ...
    var hadoken = function(){
        ...
        setTimeout(function() {
            ...
            $fireball.appendTo('.stage');
            $fireball.offset({top: $kenPos.top, left: $kenPos.left + 30});
            console.log($kenPos);

            var isFireballColision = function(){ 
                return ($guilePos.left - $fireballPos.left <= 25 && $guilePos.left - $fireballPos.left >= -20);
            };
